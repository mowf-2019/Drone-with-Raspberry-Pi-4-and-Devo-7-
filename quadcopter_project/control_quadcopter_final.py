...
def PID_roll(roll,roll_setpoint,dt):
    ...
    if roll_i >20:
        ...
        roll_i=-20
    pid_roll_output = Kp_roll*roll_error + roll_i + Kd_roll*Xrate
    if (pid_roll_output > 30):
        pid_roll_output = 30
    elif (pid_roll_output < -30):
        pid_roll_output = -30
...
def PID_pitch(pitch,pitch_setpoint,dt):
    ...
    if pitch_i >20:
        ...
        pitch_i=-20
    pid_pitch_output = Kp_pitch*pitch_error + Ki_pitch*pitch_i + Kd_pitch*Yrate
...
def PID_yaw(yaw,yaw_setpoint,dt):
    ...
    if yaw_i >20:
        ...
        yaw_i=-20
    pid_yaw_output = Kp_yaw*yaw_error + Ki_yaw*yaw_i + Kd_yaw*Zrate
...
#         esc_1_rps = throttle - PIDyaw
#         esc_2_rps = throttle + PIDyaw
#         esc_3_rps = throttle - PIDyaw
#         esc_4_rps = throttle + PIDyaw
...
#         ser.write(b'%f %f %f %f %f %f %f %f %f\r\n'%(roll, gear, esc_1_rps, esc_2_rps, esc_3_rps, esc_4_rps, throttle, lipo_volt, dt))
#         ser.flush()
    if dt2>1:
# #         print(roll,pitch,-yaw,esc_2_rps,esc_4_rps,throttle,lipo_volt)
#         print(throttle,roll,pitch,yaw,PIDroll)
        print(roll,roll_raw)
# #         print(roll,pitch,yaw,roll_setpoint,pitch_setpoint,yaw_setpoint)
        end2=time.time()
#         ser.write(b'%f %f\r\n'%(Xrate,Xrate_filt))
#         ser.write(b'%f %f %f %f %f %f\r\n'%(throttle,roll_setpoint,pitch_setpoint,yaw_setpoint,gear,dt))
#         ser.flush()
