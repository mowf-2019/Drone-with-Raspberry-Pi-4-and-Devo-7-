...
#         ser.write(b'%f %f %f %f %f %f\r\n'%(qax,qay,qaz,qrx,qry,qrz))
        ...
        GPS_lib.read_GPS()
        print(gps_roll_adjust, gps_pitch_adjust)
    if elapse_time2>1:
        end2=time.time()
...
#         print(roll,pitch,throttle,ra_offset,pa_offset,roll_setpoint,pitch_setpoint,nfb,elapse_time,lipo_volt)
        print(roll,pitch,throttle,nfb,heading)
